    ...
    try{
        ...
        if(endPostId == -1){
            ...
            if(category_id==0){
                ...
                var results = await client.query(baseQuery+"and b.post_id >= (select post_id from (select post_id from board where is_delete = false and post_id<$3 and category_id=$4 and school_id=$6 order by post_id desc limit $4  ) as not_delete order by post_id asc limit 1) \
