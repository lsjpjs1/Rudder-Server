...
async function renderPost(board_type,endPostId,category_id=0,user_id){
    try{
        ...
        (select left_join_res.* from \
            (select b.*,bl.user_id as like_user_id from \
                ...
                group by b.post_id,b.user_id,b.post_title,b.post_body,b.post_time,b.comment_count,b.like_count,b.post_view,b.board_type_id,b.category_id,b.school_id,b.is_delete,b.like_user_id,ui.user_nickname,c.category_id,bt.board_type_name having bt.board_type_name = $2 and b.is_delete = false "
        if(endPostId == -1){
            if(category_id==0){
            ...
            if(category_id==0){
                ...
                and b.post_id < $3 order by post_id desc",[user_id,board_type,endPostId,POST_NUMBER_IN_ONE_PAGE])
            }else{
                ...
                and b.post_id < $3 and b.category_id=$4 order by post_id desc limit $5",[user_id,board_type,endPostId,category_id,POST_NUMBER_IN_ONE_PAGE])
            }
...
router.post("/renderPost",async function(req,res){
    ...
    if(tk.decodeToken(token)){
        ...
        var jsonData= await renderPost(board_type,endPostId,category_id,tmp.user_id);
        res.send(jsonData);
    }
